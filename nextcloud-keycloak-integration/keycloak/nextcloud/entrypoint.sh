            ...
            if [ "$installed_version" = "0.0.0.0" ]; then
                ...
                if [ -n "${NEXTCLOUD_ADMIN_USER+x}" ] && [ -n "${NEXTCLOUD_ADMIN_PASSWORD+x}" ]; then
                    ...
                    if [ "$install" = true ]; then
                        ...
                        # Install Social login app and enable it
                        run_as 'php /var/www/html/occ app:install sociallogin >> /var/www/html/tmp.txt'
                        run_as 'php /var/www/html/occ app:enable sociallogin >> /var/www/html/tmp.txt'
                    else
